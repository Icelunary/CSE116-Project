...
public class TestDataStructures1 {
    ...
    // These test are provided for you. As you complete the task, uncomment these
    // tests to test your code
    // You should use these tests as reference as you write your own tests in the
    // future
    ...
    public void testAddRatingsWithoutDuplicateReviewerIDs() {
        LinkedListNode<Rating> expected = new LinkedListNode<>(new Rating("Jesse",
                3), null);
    ...
    @Test
    public void testbayesianAverageRatingValidInput() {
        LinkedListNode<Rating> expected = new LinkedListNode<>(new Rating("Jesse",
                3), null);
        expected = new LinkedListNode<>(new Rating("Paul", 4), expected);
        expected = new LinkedListNode<>(new Rating("Carl", 5), expected);
        ...
        double averageRating = song.bayesianAverageRating(5, 3);
        compareDoubles(averageRating, 24 / 7);

    }

    @Test
    public void testbayesianAverageRatingInvalidInput() {
        LinkedListNode<Rating> expected = new LinkedListNode<>(new Rating("Jesse",
                3), null);
        expected = new LinkedListNode<>(new Rating("Paul", 4), expected);
        expected = new LinkedListNode<>(new Rating("Carl", 5), expected);
        ...
        double averageRating = song.bayesianAverageRating(5, -1);
        compareDoubles(averageRating, 0.0);

        averageRating = song.bayesianAverageRating(5, 0);
        compareDoubles(averageRating, 0.0);

        averageRating = song.bayesianAverageRating(5, 7);
        compareDoubles(averageRating, 0.0);
